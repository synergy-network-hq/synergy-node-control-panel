# Testnet-Beta Validator Debug Cheat Sheet (Linux)
...
```bash
grep -n 'synv114cvu472rkdgpmzvkj70zk9tu8cqqlu4x9ra' "$LOG" | tail -n 80
```
...
```bash
nc -vz genesisval1.synergynode.xyz 5622
```
