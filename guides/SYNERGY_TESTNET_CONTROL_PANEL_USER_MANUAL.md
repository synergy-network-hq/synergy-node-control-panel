...
Version: 2026-05-10
Applies to: Synergy Node Control Panel `11.0.1` or newer for Synergy Testnet
...
- macOS/Linux: `~/.synergy/testnet/nodes/...`
...
Jarvis switches into Testnet ceremony mode and prompts for the role to install on the current machine.
...
After a successful import, the workspace contains the approved Testnet launch data for that role:
...
Treat Testnet as live only after all of the following are true:
