...
if [[ $# -lt 2 || $# -gt 3 ]]; then
  ...
  echo "Example: $0 release-assets v2.4.3 synergy-network-hq/testnet-control-panel-releases" >&2
  exit 1
fi

ASSETS_DIR="$1"
VERSION_TAG="$2"
RELEASES_REPO="${3:-synergy-network-hq/testnet-control-panel-releases}"
