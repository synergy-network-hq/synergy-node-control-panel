...
- SYNERGY_TESTBETA_WG_HUB_PUBLIC_IP (default: 64.227.107.57)
- SYNERGY_TESTBETA_WG_HUB_VPN_IP (default: 10.50.0.254)
- SYNERGY_TESTBETA_WG_HUB_PORT (default: 51820)
USAGE
}
...
HUB_PUBLIC_IP="${SYNERGY_TESTBETA_WG_HUB_PUBLIC_IP:-64.227.107.57}"
HUB_VPN_IP="${SYNERGY_TESTBETA_WG_HUB_VPN_IP:-10.50.0.254}"
HUB_PORT="${SYNERGY_TESTBETA_WG_HUB_PORT:-51820}"
