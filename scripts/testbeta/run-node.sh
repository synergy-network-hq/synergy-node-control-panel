...
CONFIG_FILE="$ROOT_DIR/testbeta/runtime/configs/${NODE_SLOT_ID}.toml"
DATA_DIR="$ROOT_DIR/data/testbeta15/${NODE_SLOT_ID}"
...
if [[ ! -f "$CONFIG_FILE" ]]; then
  ...
  echo "Run scripts/testbeta/render-configs.sh first." >&2
  exit 1
fi
