...
TESTBETA_VALIDATOR_CLUSTER_SIZE="${TESTBETA_VALIDATOR_CLUSTER_SIZE:-7}"
...
TESTBETA_MESH_SETTLE_SECS="${TESTBETA_MESH_SETTLE_SECS:-1}"
TESTBETA_LEADER_TIMEOUT_SECS="${TESTBETA_LEADER_TIMEOUT_SECS:-4}"
TESTBETA_VOTE_TIMEOUT_SECS="${TESTBETA_VOTE_TIMEOUT_SECS:-2}"
TESTBETA_BLOCK_TIMEOUT_SECS="${TESTBETA_BLOCK_TIMEOUT_SECS:-6}"
...
TESTBETA_P2P_HEARTBEAT_INTERVAL_SECS="${TESTBETA_P2P_HEARTBEAT_INTERVAL_SECS:-5}"
...
status_ready_gate_enabled = ${TESTBETA_STATUS_READY_GATE_ENABLED}
...
allow_genesis_status_bypass = ${TESTBETA_ALLOW_GENESIS_STATUS_BYPASS}
mesh_settle_secs = ${TESTBETA_MESH_SETTLE_SECS}
...
heartbeat_interval = ${TESTBETA_P2P_HEARTBEAT_INTERVAL_SECS}
