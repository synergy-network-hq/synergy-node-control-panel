...
event_seed="sxcp-devnet-intent-$(date +%s)"
...
for index in "${!relayer_array[@]}"; do
  ...
  metadata="{\"source_chain\":\"sepolia\",\"destination_chain\":\"synergy-devnet\",\"intent_id\":\"$event_seed\",\"proof_type\":\"quorum-smoke\",\"signature_algorithm\":\"fndsa\",\"step\":$((index + 1)),\"threshold\":$threshold}"
