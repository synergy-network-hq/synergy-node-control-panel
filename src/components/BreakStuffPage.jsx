...
function BreakStuffPage() {
  return (
    <FutureLabPage
      ...
      intro="This area is reserved for deliberate network abuse testing. It will be used to pressure the network, create hostile conditions, and verify that consensus, monitoring, and recovery logic behave the way they should."
