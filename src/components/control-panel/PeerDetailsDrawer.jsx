  ...
  return (
    <div className="cp-peer-drawer">
      ...
      <div className="cp-definition-list">
        ...
        {renderValue('Version', peer.peerVersion || peer.protocolVersion || 'Unavailable')}
        {mode === 'developer' ? renderValue('Peer ID', peer.peerId || peer.id || 'Unavailable') : null}
        {mode === 'developer' ? renderValue('Transport', peer.transport || 'Unavailable') : null}
      </div>
      {mode === 'developer' ? (
