...
const capabilities = [
  ...
  },
  {
    ...
    description: 'Capture transaction recipes so the same devnet checks can be repeated after resets, installer updates, or protocol changes.',
  },
];
...
function TestTransactionsPage() {
  return (
    <FutureLabPage
      ...
      subtitle="A dedicated control surface for generating explorer-visible devnet activity."
      ...
      futureNote="In a future update, this page will let you choose transaction classes, target nodes or wallets, and push reproducible test activity into the devnet."
      accent="cyan"
    />
  );
}
